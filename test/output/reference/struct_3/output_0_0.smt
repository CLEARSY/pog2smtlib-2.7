...
(assert (!
  (not
    (|set.subseteq struct(Note : Z, Suffisant : BOOL)| (|struct struct(Note : Z, Suffisant : BOOL)| (lambda ((x |struct(Note : Z, Suffisant : BOOL)|)) (and (|set.in Z| (Note x) (|interval| 0 21))(|set.in BOOL| (Suffisant x) BOOL)))) (|struct struct(Note : Z, Suffisant : BOOL)| (lambda ((x |struct(Note : Z, Suffisant : BOOL)|)) (and (|set.in Z| (Note x) (|interval| 0 20))(|set.in BOOL| (Suffisant x) BOOL))))))
  :named |Goal|))
(check-sat)
(exit)
