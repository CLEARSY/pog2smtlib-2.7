...
(declare-fun |set.subseteq struct(Note : Z, Suffisant : BOOL)| (|POW struct(Note : Z, Suffisant : BOOL)| |POW struct(Note : Z, Suffisant : BOOL)|) Bool)
(assert (!
    (forall ((s |POW struct(Note : Z, Suffisant : BOOL)|) (t |POW struct(Note : Z, Suffisant : BOOL)|))
      (=
        (|set.subseteq struct(Note : Z, Suffisant : BOOL)| s t)
        (forall ((e |struct(Note : Z, Suffisant : BOOL)|)) (=> (|set.in struct(Note : Z, Suffisant : BOOL)| e s) (|set.in struct(Note : Z, Suffisant : BOOL)| e t)))
      )
    )
    :named |ax.set.subseteq struct(Note : Z, Suffisant : BOOL)|))
(assert (!
  (not (|set.subseteq struct(Note : Z, Suffisant : BOOL)| (|struct struct(Note : Z, Suffisant : BOOL)| (lambda ((x |struct(Note : Z, Suffisant : BOOL)|)) (and (|set.in Z| (Note x) (|interval| 0 21))(|set.in BOOL| (Suffisant x) BOOL)))) (|struct struct(Note : Z, Suffisant : BOOL)| (lambda ((x |struct(Note : Z, Suffisant : BOOL)|)) (and (|set.in Z| (Note x) (|interval| 0 20))(|set.in BOOL| (Suffisant x) BOOL))))))
  :named |Goal|)
)
(check-sat)
(exit)
