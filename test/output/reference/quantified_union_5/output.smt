...
(= (snd c) (|set.intent POW Z| (lambda ((x |POW Z|)) (or (= x (|set.intent Z| (lambda ((x |Z|)) (or (= x 0)(= x 1)(= x 10)))))(= x (|set.intent Z| (lambda ((x |Z|)) (or (= x 2)(= x 4)))))(= x (|set.intent Z| (lambda ((x |Z|)) (or (= x 2)(= x 30)(= x 5)))))))))
))  (lambda ((c |(Z x POW POW Z)|)) (|set.intent POW Z| (lambda ((x |POW Z|)) (and
(|set.in POW Z| x (snd c))
(|set.in Z| (fst c) x)
))))) (|set.intent POW Z| (lambda ((x |POW Z|)) (or (= x (|set.intent Z| (lambda ((x |Z|)) (or (= x 2)(= x 4)))))(= x (|set.intent Z| (lambda ((x |Z|)) (or (= x 2)(= x 30)(= x 5))))))))))
  :named |Goal|)
)
(check-sat)
(exit)
