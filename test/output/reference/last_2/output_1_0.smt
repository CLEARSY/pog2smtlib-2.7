...
(assert (!
  (not
    (|set.in POW (Z x Z)| (|set.intent (Z x Z)| (lambda ((_c0 |(Z x Z)|)) (or (= _c0 (maplet 1 5))(= _c0 (maplet 2 5))(= _c0 (maplet 3 7))))) (|seq Z| (|rel.range Z Z| (|set.intent (Z x Z)| (lambda ((_c0 |(Z x Z)|)) (or (= _c0 (maplet 1 5))(= _c0 (maplet 2 5))(= _c0 (maplet 3 7)))))))))
  :named |Goal|))
(check-sat)
(exit)
