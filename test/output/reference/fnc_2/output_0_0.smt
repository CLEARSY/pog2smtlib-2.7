...
(assert (!
  (not
    (|set.in (Z x POW POW Z)| (maplet 0 (|set.intent POW Z| (lambda ((x |POW Z|)) (or (= x (|set.intent Z| (lambda ((x |Z|)) (or (= x 1)(= x 2)(= x 4)))))(= x (|set.intent Z| (lambda ((x |Z|)) (or (= x 1)(= x 2)(= x 4)(= x 6)(= x 7))))))))) (|fnc Z POW Z| func)))
  :named |Goal|))
(check-sat)
(exit)
