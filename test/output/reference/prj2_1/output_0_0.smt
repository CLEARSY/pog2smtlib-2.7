...
(assert (!
  (not
    (= (|prj1 Z Z| (|set.intent Z| (lambda ((_c0 |Z|)) (or (= _c0 0)(= _c0 1)))) (|set.intent Z| (lambda ((_c0 |Z|)) (or (= _c0 3)(= _c0 2))))) (|set.intent ((Z x Z) x Z)| (lambda ((_c0 |((Z x Z) x Z)|)) (or (= _c0 (maplet (maplet 0 3) 3))(= _c0 (maplet (maplet 0 2) 2))(= _c0 (maplet (maplet 1 3) 3))(= _c0 (maplet (maplet 1 2) 1)))))))
  :named |Goal|))
(check-sat)
(exit)
