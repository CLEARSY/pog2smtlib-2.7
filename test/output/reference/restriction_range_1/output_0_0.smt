...
(assert (!
  (not
    (= (|rel.restrict.ran Z Z| (|set.intent (Z x Z)| (lambda ((_c0 |(Z x Z)|)) (or (= _c0 (maplet 2 1))(= _c0 (maplet 3 1))(= _c0 (maplet 5 5))))) (|set.intent Z| (lambda ((_c0 |Z|)) (= _c0 1)))) (|set.intent (Z x Z)| (lambda ((_c0 |(Z x Z)|)) (= _c0 (maplet 2 1))))))
  :named |Goal|))
(check-sat)
(exit)
