...
(assert (!
  (not
    (= (|rel.restrict.dom Z Z| (|set.intent Z| (lambda ((_c0 |Z|)) (or (= _c0 1)(= _c0 2)(= _c0 3)))) (|set.intent (Z x Z)| (lambda ((_c0 |(Z x Z)|)) (or (= _c0 (maplet 2 0))(= _c0 (maplet 2 1))(= _c0 (maplet 3 5))(= _c0 (maplet 4 0))(= _c0 (maplet 4 9)))))) (|set.intent (Z x Z)| (lambda ((_c0 |(Z x Z)|)) (or (= _c0 (maplet 2 0))(= _c0 (maplet 2 1))(= _c0 (maplet 3 6)))))))
  :named |Goal|))
(check-sat)
(exit)
