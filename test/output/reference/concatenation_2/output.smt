...
(assert (!
  (not (= (|^ Z| (|set.intent (Z x Z)| (lambda ((x |(Z x Z)|)) (or (= x (maplet 0 3))(= x (maplet 1 1))))) (|set.intent (Z x Z)| (lambda ((x |(Z x Z)|)) (or (= x (maplet 0 0))(= x (maplet 1 2))(= x (maplet 2 4)))))) (|set.intent (Z x Z)| (lambda ((x |(Z x Z)|)) (or (= x (maplet 0 3))(= x (maplet 1 1))(= x (maplet 2 0))(= x (maplet 3 2))(= x (maplet 4 4)))))))
  :named |Goal|)
)
(check-sat)
(exit)
