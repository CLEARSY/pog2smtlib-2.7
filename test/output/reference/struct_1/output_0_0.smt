...
(assert (!
  (not
    (|set.in struct(Note : Z, Suffisant : BOOL)| (|record struct(Note : Z, Suffisant : BOOL)| 21 false) (|struct struct(Note : Z, Suffisant : BOOL)| (lambda ((x |struct(Note : Z, Suffisant : BOOL)|)) (and (|set.in Z| (Note x) (|interval| 0 20))(|set.in BOOL| (Suffisant x) BOOL))))))
  :named |Goal|))
(check-sat)
(exit)
